...
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Doctor', 'A101', 0, NULL, '123 Elm St', 'City A');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Doctor', 'A101', 0, NULL, '123 Elm St', 'City A');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Doctor', 'A101', 0, NULL, '123 Elm St', 'City A');
...
-- 5 Technicans
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (6, 'Tom', 'Wilson', 70000, 'Technician', 'B101', 0, NULL, '303 Cedar St', 'City F');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (7, 'Anna', 'Taylor', 72000, 'Technician', 'B102', 0, NULL, '404 Walnut St', 'City G');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (8, 'Lucas', 'Anderson', 68000, 'Technician', 'B103', 0, NULL, '505 Spruce St', 'City H');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (9, 'Sophia', 'Lee', 73000, 'Technician', 'B104', 0, NULL, '606 Fir St', 'City I');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (10, 'David', 'Martin', 71000, 'Technician', 'B105', 0, NULL, '707 Ash St', 'City J');


-- 5 Cleaners
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (11, 'Liam', 'Thomas', 40000, 'Cleaner', 'C101', 0, NULL, '808 Chestnut St', 'City K');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (12, 'Olivia', 'Garcia', 42000, 'Cleaner', 'C102', 0, NULL, '909 Willow St', 'City L');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (13, 'Noah', 'Moore', 41000, 'Cleaner', 'C103', 0, NULL, '101 Poplar St', 'City M');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (14, 'Isabella', 'Jackson', 43000, 'Cleaner', 'C104', 0, NULL, '202 Redwood St', 'City N');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (15, 'Mason', 'White', 42000, 'Cleaner', 'C105', 0, NULL, '303 Cypress St', 'City O');

-- 4 division managers
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Division Manager', 'A101', 1, NULL, '123 Elm St', 'City A');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Division Manager', 'A101', 1, NULL, '123 Elm St', 'City A');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'Division Manager', 'A101', 1, NULL, '123 Elm St', 'City A');
...
-- 2 General Managers
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'General Manager', 'A101', 2, NULL, '123 Elm St', 'City A');
INSERT INTO EMPLOYEE(ID, FNAME, LNAME, SALARY, JOBTITLE, OFFICENUM, EMPRANK, SUPERVISORID, ADDRESSSTREET, ADDRESSCITY) VALUES
    (1, 'John', 'Doe', 50000, 'General Manager', 'A101', 2, NULL, '123 Elm St', 'City A');